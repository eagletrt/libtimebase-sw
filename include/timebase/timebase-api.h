 ...
 */
enum TimebaseReturnCode timebase_api_init(struct TimebaseHandler *handler, const uint32_t resolution_ms);
 ...
 */
void timebase_set_enable(struct TimebaseHandler *handler, const bool enabled);
 ...
 * \retval TIMEBASE_RC_OK otherwise
 */
enum TimebaseReturnCode timebase_inc_tick(struct TimebaseHandler *handler);
 ...
 */
uint32_t timebase_get_tick(struct TimebaseHandler *handler);
 ...
 */
uint32_t timebase_get_time(struct TimebaseHandler *handler);
 ...
 */
uint32_t timebase_get_resolution(struct TimebaseHandler *handler);
